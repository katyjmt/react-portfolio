    ...
    <>
      ...
      <div className="intro-container">
        <p className="intro">
          ...
          years, over which time I&apos;ve worn multiple hats as project
          ...
          out of working out how to do something from first principles. Over the
          ...
          about what good design is. How to create something that&apos;s not
          just aesthetically delightful, but that is designed around a deep
